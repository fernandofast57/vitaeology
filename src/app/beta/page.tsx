...
function BetaPageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setIsSubmitted(true);
      setWillBeApproved(data.willBeApproved === true);
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden" id="form">
          ...
          <div className="p-6 lg:p-8">
            {isSubmitted ? (
              // Success State - Different for pending approval vs waitlist
                ...
                {willBeApproved ? (
                  ...
                  <>
                    ...
                    <p className="text-gray-600 max-w-md mx-auto mb-4">
                      Grazie per il tuo interesse nel programma <strong className="text-gold-600">Founding Tester</strong>.
                    </p>
                    <div className="bg-petrol-50 rounded-xl px-6 py-4 inline-block mb-4">
                      <p className="text-sm text-petrol-600 flex items-center gap-2 justify-center">
                        <Clock className="w-4 h-4" />
                        Riceverai conferma via email entro 24 ore
                      </p>
                    </div>
                    <p className="text-gray-500 text-sm max-w-md mx-auto">
                      Controlla la tua casella email (anche spam) per le istruzioni su come accedere alla piattaforma.
                    </p>
                    <Link
                      href="/"
