// POST /api/auth/signup - Registrazione con Turnstile + OTP
// Step 1: Valida email, genera OTP, invia email
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { email, password, fullName, turnstileToken, bookCode } = body;
    ...
    // 8. Successo - salva temporaneamente i dati per il verify
