-- ============================================================
-- ESERCIZI RISOLUTORE V2 - MAPPATI ALLE 7 DIMENSIONI ASSESSMENT
-- 14 esercizi (2 per dimensione): FP, FS, FR, TP, TT, TC, SR
...
-- ═══════════════════════════════════════════════════════════════
-- FILTRO FP: DETECTIVE DEI PATTERN (2 esercizi)
-- Capacità di riconoscere schemi ricorrenti e connessioni nascoste
-- ═══════════════════════════════════════════════════════════════
(
...
-- ═══════════════════════════════════════════════════════════════
-- FILTRO FS: ANTENNA DEI SEGNALI (2 esercizi)
-- Capacità di leggere bisogni non detti e comunicazioni nascoste
-- ═══════════════════════════════════════════════════════════════
(
...
-- ═══════════════════════════════════════════════════════════════
-- FILTRO FR: RADAR DELLE RISORSE (2 esercizi)
-- Capacità di identificare e combinare creativamente risorse disponibili
-- ═══════════════════════════════════════════════════════════════
(
...
-- ═══════════════════════════════════════════════════════════════
-- TRADITORE TP: IL PARALIZZANTE (2 esercizi)
-- Blocco che impedisce di iniziare per paura di sbagliare
-- ═══════════════════════════════════════════════════════════════
(
...
-- ═══════════════════════════════════════════════════════════════
-- TRADITORE TT: IL TIMOROSO (2 esercizi)
-- Paura del giudizio e dell'esposizione che limita l'azione
-- ═══════════════════════════════════════════════════════════════
(
...
-- ═══════════════════════════════════════════════════════════════
-- TRADITORE TC: IL PROCRASTINATORE (2 esercizi)
-- Tendenza a rimandare l'azione nonostante la consapevolezza
-- ═══════════════════════════════════════════════════════════════
(
...
-- ═══════════════════════════════════════════════════════════════
-- SCALA SR: LIVELLO RISOLUTORE (2 esercizi)
-- Livello di maturità come risolutore (1-5)
-- ═══════════════════════════════════════════════════════════════
(
